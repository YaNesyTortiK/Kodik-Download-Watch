...
CACHE_LIFE_TIME = 1 # (В днях) Как часто будет обновляться информация в базе
        # По примерным прикидкам, сслыка на mp4 файл актуальна день или менее
...
KODIK_PROXY = None # Параметры прокси для кодика (прим: 'socks5://user:pass@host:port' или 'http://host:port')
SHIKI_PROXY = None # Параметры прокси для шикимори (прим: 'socks5://user:pass@host:port' или 'http://host:port')
