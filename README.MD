...
2. Создайте и активируйте виртульное окружение
```commandline
python -m venv venv
...
### Про токен
Данный токен был найден в открытых источниках. Для его изменения в файле main.py измените соответствующую строку